...
<html>
    ...
    <body>
        <article>
            ...
            <p>Scheduled maintenance is currently in progress, it would take 20 minutes, please check back later.</p>
            <p>We apologize for any inconvenience.</p>
            <p id="signature">&mdash; <a href="">Click to contact us</a></p>
        </article>
    </body>
</html>
